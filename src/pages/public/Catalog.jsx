    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="sticky top-0 z-30 space-y-2 bg-white pb-3 pt-1 sm:space-y-3">
        ...
        <div className="mb-4 flex sm:items-start items-center gap-2 sm:gap-4 sm:mb-5">
          ...
          <div className="flex flex-1 items-center overflow-x-auto sm:overflow-visible hide-scrollbar snap-x snap-proximity py-1 -mx-4 px-4 sm:mx-0 sm:px-0 sm:py-0">
            <div className="flex items-center flex-nowrap sm:flex-wrap gap-2 sm:gap-2.5">
              <button
                onClick={() => setSelectedCategory("all")}
                className={`snap-start shrink-0 whitespace-nowrap rounded-full px-3.5 py-1.5 text-[13px] font-medium transition-colors sm:px-3.5 sm:py-1.5 sm:text-xs ${
